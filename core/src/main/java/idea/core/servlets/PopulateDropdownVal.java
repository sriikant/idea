...
public class PopulateDropdownVal extends SlingSafeMethodsServlet {

    /**
	 * 
	 */
	private static final long serialVersionUID = -7076200247674694311L;
	private static Logger LOGGER = LoggerFactory.getLogger(PopulateDropdownVal.class);
    ...
    protected void doGet(SlingHttpServletRequest request,
        ...
        try {
            ...
            String path = "/content/populatedropdown";
            ...
            response.getWriter().write("The response came");
        } catch (Exception e) {
