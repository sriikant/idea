...
import idea.core.schedulers.SlingSchedulerConfiguration;
...
public class CustomScheduler implements Runnable {
	...
	protected void activate(SlingSchedulerConfiguration config) {
		log.info("Activating schedulerId");
		/**
	...
	public void run() {
		 try {
			 log.info("Create node is etting call");
			String myResponse = getJsonUrl.sendGET();
			getJsonUrl.createNode( resresolve, myResponse);
		} catch (IOException e) {
