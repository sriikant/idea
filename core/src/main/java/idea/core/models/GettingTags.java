...
public class GettingTags extends WCMUsePojo {
	protected static Logger log = LoggerFactory.getLogger(GettingTags.class);
	...
	public void activate() throws Exception {
		...
		if (vm.containsKey("cq:tags")) {
			...
			if(tagIDs.length > 0) {
				...
				this.tagList = new ArrayList<TagCountBean>();
